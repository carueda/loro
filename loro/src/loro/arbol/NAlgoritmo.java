...
//////////////////////////////////////////////////////////////////////
/**
 * Node to represent an algorithm.
 */
public class NAlgoritmo extends NUnidad implements IUnidad.IAlgoritmo
{
	...
	public String toString() {
		if ( clase == null ) {
			...
			return Str.get("algorithm")+ " " +pkg + getPrototype();
		}
		else {
			return
				Str.get("method")+ " " +clase.obtNombreCompletoCadena()+ "." 
				+getPrototype()
			;
		}
	}
	...
	////////////////////////////////////////////////////////////////////
	/**
	 * Returns Str.get("algorithm_for")+ " " +getSpecificationName()
	 */
	public String getTypeString() {
		return Str.get("algorithm_for")+ " " +getSpecificationName();
	}
