...
throws VisitanteException
{
	...
	spc.updateSpc(+1);
	out.println(spc.spc+ "// ATRIBUTOS:\n");
	out.print(spc.spc);
	visitarLista(n.obtParametrosEntrada(), ";\n" + spc.spc);
	out.println(";\n");
	out.println(spc.spc+ "// CONSTRUCTORES:\n");
	out.print(spc.spc);
...
//		n.obtPoscondicion().aceptar(this);
	spc.updateSpc(+1);
	out.println(spc.spc+ "// acciones");
	out.print(spc.spc);
	visitarLista(n.obtAcciones(), ";\n" + spc);
	out.println(";");
	spc.updateSpc(-1);
	out.println(spc.spc + "} // fin constructor " +id);
}
...
throws VisitanteException
{
	out.println("/**");
	spc.updateSpc(+1);
	out.println(spc.spc + "Interface para la especificacion " +n.obtId()+ ".");
	spc.updateSpc(-1);
	out.println("*/");
...
//		n.pos.aceptar(this);
	...
	throws VisitanteException
	{
		out.println("\n// Generado por loroj (" +new java.util.Date()+ ")\n");
