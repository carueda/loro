...
public class Token
{
	...
	/**
	 * Prompt token id. carueda 10/09/01
	 */
	public static final byte PROMPT = 11;

	/**
	 * subprocess token id. carueda 10/09/01
	 */
	public static final byte SPECIAL = 12;

	/**
	 * DOC token id. carueda 08/26/02
	 */
	public static final byte DOC = 13;

	/**
	 * GUIDE token id. carueda 08/26/02
	 */
	public static final byte GUIDE = 14;

	/**
	 * IMPL token id. carueda 10/09/02
	 */
	public static final byte IMPL = 15;

	/**
	 * The total number of defined token ids.
	 */
	public static final byte ID_COUNT = 11 + 1 + 1 + 1 + 1 + 1;  // carueda
