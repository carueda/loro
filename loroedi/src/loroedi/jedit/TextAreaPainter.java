...
public class TextAreaPainter extends JComponent implements TabExpander
{
	...
	public TextAreaPainter(JEditTextArea textArea, TextAreaDefaults defaults)
	{
		...
		// carueda 2001-08-26 ///////////////////////////
		//setBackground(Color.white);  <- original
	...
	/**
	 * carueda: 2001-08-16
	 * Un poco mas grueso el caret y siempre llenando (fillRect).
	 */
	protected void paintCaret(Graphics gfx, int line, int y)
	{
		if(textArea.isCaretVisible())
		{
			...
			int caretWidth = ((blockCaret ||
				...
				fm.charWidth('w') : 3);	// originalmente 1
			y += fm.getLeading() + fm.getMaxDescent();
			int height = fm.getHeight();
			...
			{
				gfx.fillRect(caretX,y + height - 4,
					caretWidth, 3); // originalmente 1
			}
			else
			{
	...
	public void setFont(Font font)
	{
		...
		// carueda: para evitar "deprecated"  (2002-02-10)
		// codigo original:
		//    fm = Toolkit.getDefaultToolkit().getFontMetrics(font);
		// provoca "deprecated". 
		// Pero mi getFontMetrics heredado de Component funciona bien:
